...
two("pill_orange",60,22,f'<rect stroke="{STROKE}" fill="#c8641e" x="0.5" y="0.5" width="59" height="21" rx="10.5"/>',f'<rect stroke="{STROKE}" fill="#9c4d14" x="0.5" y="0.5" width="59" height="21" rx="10.5"/>')
two("pill_greycyan",60,22,f'<rect stroke="{STROKE}" fill="#4a5c5e" x="0.5" y="0.5" width="59" height="21" rx="10.5"/>',f'<rect stroke="{STROKE}" fill="#3a4a4c" x="0.5" y="0.5" width="59" height="21" rx="10.5"/>')
two("round_red",29,29,f'<circle stroke="{STROKE}" fill="#b02020" cx="14.5" cy="14.5" r="14"/>',f'<circle stroke="{STROKE}" fill="#801414" cx="14.5" cy="14.5" r="14"/>')
