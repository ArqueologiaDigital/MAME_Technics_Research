-- sdsave1: SD SAVE round-trip step 1 -- reach the SAVE browser and attempt a TECHNICS FORMAT save.
...
local steps = {
  ...
  {31.5, function() snap("S3-savemenu"); press(LCDR1) end},
  {31.9, function() rel(LCDR1) end},
  {34.5, function() snap("S4-savebrowser"); press(LCDR1) end},
  {34.9, function() rel(LCDR1) end},
  {38.5, function() snap("S5-aftersave") end},
  {43.0, function() snap("S6-settle"); log("SAVE PROBE COMPLETE") end},
}
local i = 1
