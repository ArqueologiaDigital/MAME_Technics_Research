...
Generated by `tools/gen_rig_index.py` from each rig's own header — 116 rigs. Run any of them with `./tools/rig.sh <rig>`.
...
**✔** = the header documents a runnable `rig.sh` command. 26 of 116 do; the rest still need one.
