...
Generated by `tools/gen_rig_index.py` from each rig's own header — 118 rigs. Run any of them with `./tools/rig.sh <rig>`.
...
**✔** = the header documents a runnable `rig.sh` command. 48 of 118 do; the rest still need one.
