...
Generated by `tools/gen_rig_index.py` from each rig's own header — 113 rigs. Run any of them with `./tools/rig.sh <rig>`.
...
**✔** = the header documents a runnable `rig.sh` command. 23 of 113 do; the rest still need one.
