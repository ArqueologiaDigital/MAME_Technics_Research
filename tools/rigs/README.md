...
Generated by `tools/gen_rig_index.py` from each rig's own header — 125 rigs. Run any of them with `./tools/rig.sh <rig>`.
...
**✔** = the header documents a runnable `rig.sh` command. 53 of 125 do; the rest still need one.
