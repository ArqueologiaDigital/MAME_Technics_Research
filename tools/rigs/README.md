...
Generated by `tools/gen_rig_index.py` from each rig's own header — 127 rigs. Run any of them with `./tools/rig.sh <rig>`.
...
**✔** = the header documents a runnable `rig.sh` command. 55 of 127 do; the rest still need one.
