-- sdsave3 run B: reach the SD SAVE browser (TECHNICS FORMAT) and press SAVE (LCDR1).
...
local steps = {
  ...
  {37.5, function() snap("S5-aftersave1") end},
  {41.0, function() snap("S6-aftersave2") end},
  {46.0, function() snap("S7-settle"); log("RUN B COMPLETE") end},
}
local i = 1
