-- Run B2: remaining soft keys from a verified SD MENU state
TRIALS = {
  {tag=":cpanel:CPR_SEG5", mask=0x20, name="LCDR2-SAVE"},
  {tag=":cpanel:CPR_SEG6", mask=0x01, name="LCDR4-SDAUDIO"},
  {tag=":cpanel:CPL_SEG0", mask=0x02, name="LCDL1-SDTOOLS"},
  {tag=":cpanel:CPL_SEG0", mask=0x20, name="LCDL3-FAVSONGS"},
  {tag=":cpanel:CPL_SEG0", mask=0x04, name="LCDL5-blank5"},
}
