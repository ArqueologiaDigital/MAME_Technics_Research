-- Run D: the six CPSD SD-board switches on the SD MENU
TRIALS = {
  {tag=":CPSD_SDSW", mask=0x01, name="SDSW-VOLdn"},
  {tag=":CPSD_SDSW", mask=0x02, name="SDSW-VOLup"},
  {tag=":CPSD_SDSW", mask=0x04, name="SDSW-STOP"},
  {tag=":CPSD_SDSW", mask=0x08, name="SDSW-PLAY"},
  {tag=":CPSD_SDSW", mask=0x10, name="SDSW-REW"},
  {tag=":CPSD_SDSW", mask=0x20, name="SDSW-FWD"},
}
...
local function calibrate()
  ...
  if fx then probe_x, probe_y = fx, fy
