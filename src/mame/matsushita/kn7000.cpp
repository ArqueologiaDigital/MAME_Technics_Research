...
static INPUT_PORTS_START(kn7000)
	...
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("CONTRAST + (guess)")
	PORT_BIT(0xfe, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("SEG17")   // normSeg 0x17 -- wire ADDR 0xD1
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("CONTRAST - (guess)")
	PORT_BIT(0xfe, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("SEG18")   // normSeg 0x18 -- wire ADDR 0xD2
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("PAGE UP (guess)")
	PORT_BIT(0xfe, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("SEG19")   // normSeg 0x19 -- wire ADDR 0xD3
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("PAGE DOWN (guess)")
	PORT_BIT(0xfe, IP_ACTIVE_HIGH, IPT_UNUSED)
