...
static INPUT_PORTS_START(kn7000)
	...
	PORT_START("CPL_SEG0")   // CPL physical SEG column 0
	...
	PORT_START("CPL_SEG1")   // CPL physical SEG column 1
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("MEMORY/LOAD (SW0)")
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("SOUL & FUNK (SW1)")
	...
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("JAZZ COMBO (SW4)")
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("ROCK & POP (SW5)")
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("BIG BAND & SWING (SW6) [unbound]")
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("8 & 16 BEAT (SW7)")
	PORT_START("CPL_SEG2")   // CPL physical SEG column 2
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("MOVIE SHOW (SW0)")
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("MARCH (SW1)")
	PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("ENTERTAINER (SW2)")
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("GOSPEL & BLUES (SW5) [unbound]")
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("BALLROOM (SW6)")
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("MODERN DANCE (SW7)")
	PORT_START("CPL_SEG3")   // CPL physical SEG column 3
	...
	PORT_START("CPL_SEG4")   // CPL physical SEG column 4
	...
	PORT_START("CPL_SEG6")   // CPL physical SEG column 6
	...
	PORT_START("CPL_SEG7")   // CPL physical SEG column 7
	...
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("CPC_SEG5")   // CPC physical SEG column 5
	...
	PORT_START("CPC_SEG8")   // CPC physical SEG column 8
	...
	PORT_START("CPC_SEG9")   // CPC physical SEG column 9
	...
	PORT_START("CPC_SEG10")   // CPC physical SEG column 10
	...
	PORT_START("CPC_SEG11")   // CPC physical SEG column 11
	...
	PORT_START("CPR_SEG0")   // CPR physical SEG column 0
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("BASS (SW5)")
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("CUSTOMIZE (SW6)")
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("CPR_SEG1")   // CPR physical SEG column 1
	...
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("BRASS (SW4)")
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("SYNTH (SW5)")
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("CUSTOM PANEL (SW6) [unbound]")
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("SD CARD LOAD (SW7)")
	PORT_START("CPR_SEG2")   // CPR physical SEG column 2
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("PART SELECT LEFT (SW0)")
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("PART SELECT RIGHT 1 (SW1)")
	...
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("CPR_SEG3")   // CPR physical SEG column 3
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("TRANSPOSE R1 (+) (SW0)")
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("CONDUCTOR RIGHT 2 (SW1)")
	...
	PORT_START("CPR_SEG4")   // CPR physical SEG column 4
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("TRANSPOSE R1 (-) (SW0)")
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("CONDUCTOR RIGHT 1 (SW1)")
	...
	PORT_START("CPR_SEG5")   // CPR physical SEG column 5
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("LCDR 5 (SW0) [unbound]")
	...
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("LCDR 1 (SW4) [unbound]")
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("LCDR 2 (SW5) [unbound]")
	...
	PORT_START("CPR_SEG6")   // CPR physical SEG column 6
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("LCDR 4 (SW0) [unbound]")
	...
	PORT_START("CPR_SEG7")   // CPR physical SEG column 7
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("LCDR 3 (SW0) [unbound]")
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("TRANSPOSE R2 (-) (SW1)")
	...
	PORT_START("CPR_SEG8")   // CPR physical SEG column 8
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("ACCORDION REGISTER (SW2)")
	PORT_BIT(0x08, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("ORGAN & ACCORDION (SW3)")
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_START("CPR_SEG9")   // CPR physical SEG column 9
	PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_UNUSED)
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_UNUSED)
...
void kn7000_state::kn7000(machine_config &config)
{
	...
	// Physical panel-board button ports (CP{board}_SEG{col}); the device translates
	// them to the sub-CPU wire frames via its PHYS_MAP.
	static const char *const phys_tags[22] =
	{
		":CPL_SEG0",
		":CPL_SEG1",
		":CPL_SEG2",
	...
	for (int i = 0; i < 22; i++)
		m_cpanel->set_phys_port(i, phys_tags[i]);
