...
static INPUT_PORTS_START(kn5000)
	...
	// discarded. 199 of the 285 words on the frame path now execute -- but only 80 of
	// them FULLY: the other 119 have their ADDRESSING executed and their arithmetic
