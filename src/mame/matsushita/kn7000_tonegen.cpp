...
/***************************************************************************
    ...
    See kn7000_tonegen.h for the rationale and the note references. This file
    holds the register decode (tg_write), the per-voice envelope resolve, and
    the audio stream.
...
double kn7000_tonegen_device::eg_tau(uint8_t rate)
{
...
void kn7000_tonegen_device::key_break(uint8_t key)
{
	for (int v = 0; v < 128; v++)
